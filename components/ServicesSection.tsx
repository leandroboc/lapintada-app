...
export default function ServicesSection() {
  return (
    <section id="eventos" className="py-20 bg-[#fdf6ef]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-[#fffaf5] rounded-xl shadow-xl p-8 md:p-10 border-t-4 border-[#d8b28a]" data-aos="fade-up">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* Servicio 1 */}
            <div className="text-center p-6 rounded-lg hover:shadow-lg transition-shadow duration-300 group">
              <div className="w-20 h-20 mx-auto bg-[#ead8c8] rounded-full flex items-center justify-center text-[#866850] mb-4 group-hover:bg-[#d8b28a] group-hover:text-white transition-colors">
