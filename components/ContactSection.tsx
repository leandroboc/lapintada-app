      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Estamos aquí para ayudarte. Contáctanos para cualquier consulta sobre nuestros servicios de transporte.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <div data-aos="fade-right">
            <div className="bg-white rounded-2xl p-8 shadow-lg">
              ...
              <div className="flex items-start mb-6">
                <div className="bg-libertador-blue/10 rounded-lg p-3 mr-4">
                  <svg className="w-6 h-6 text-libertador-blue" fill="currentColor" viewBox="0 0 20 20">
          ...
          <div data-aos="fade-left">
            <div className="bg-white rounded-2xl p-4 shadow-lg h-full">
              ...
              <div className="mt-4 p-3 bg-libertador-blue/5 rounded-lg">
                <p className="text-sm text-gray-600 flex items-center">
                  <svg className="w-4 h-4 text-libertador-blue mr-2" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M5.05 4.05a7 7 0 119.9 9.9L10 18.9l-4.95-4.95a7 7 0 010-9.9zM10 11a2 2 0 100-4 2 2 0 000 4z" clipRule="evenodd" />
                  </svg>
