...
import GoogleOpinionsSection from '../components/GoogleOpinionsSection'
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-0">
              ...
              <div className="lg:col-span-7 px-6 pb-8 md:px-8 md:pb-10 lg:pr-10 lg:pl-2 flex items-center">
                <div className="max-w-xl">
                  ...
                  <p className="text-2xl md:text-3xl text-[#5f4b3e] font-bold leading-tight md:leading-[1.35]">
                    Donde la energía se transforma en recuerdo.
                    <br />
                    Cada detalle en su lugar, cada instante en movimiento.
                    <br />
                    No es solo una noche. Es lo que queda después
                  </p>
                </div>
              </div>
            </div>
