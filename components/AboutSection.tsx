...
export default function AboutSection() {
  return (
    <section id="espacios" className="py-20 bg-white overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div data-aos="fade-right">
            ...
            <a
              href="#contacto"
              className="inline-block border-b-2 border-pintada-gold text-gray-900 font-semibold pb-1 hover:text-pintada-gold transition-colors duration-300 uppercase tracking-widest text-sm"
            >
